...
public class PanelCover extends javax.swing.JPanel {
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                title.setText("Bon retour!");
                description1.setText("Veuilez en creer un");

                description.setText("Si vous n'avez pas de compte");
                button.setText("S'INSCRIRE");
            } else {
                title.setText("Bienvenu :)");
                description.setText("Merci de remplir tous les champs");
                description1.setText("Entrez les informations  comme indiquees");
